...
def test_get_missing_glyphs_cmap_encoding_2():
...
def test_get_missing_glyphs_cmap_encoding_mac_platform():
...
def test__repr__():
    ...
    name = Name("value", Language.get("fr")) 
    family_names = {name}
    name = Name("value 1", Language.get("fr")) 
    exact_names = {name}
